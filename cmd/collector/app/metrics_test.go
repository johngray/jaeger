...
func TestProcessorMetrics(t *testing.T) {
	...
	assert.EqualValues(t, 1, counters["service.jaeger.spans.by-svc.fry|debug=false"])
	assert.EqualValues(t, 2, counters["service.jaeger.spans.by-svc.fry|debug=true"])
	assert.EqualValues(t, 1, counters["service.jaeger.traces.by-svc.fry|debug=false"])
	assert.EqualValues(t, 1, counters["service.jaeger.traces.by-svc.fry|debug=true"])
